#!/usr/bin/env python3
"""
Скрипт для выполнения миграции: добавление поля benchmark_rating в таблицу pc_cpus.
"""
import os
import sys
...
def run_migration():
    """Выполняет миграцию для добавления поля benchmark_rating."""
    ...
    try:
        ...
        # Читаем SQL файл
        migration_file = project_root / 'migrations' / 'add_benchmark_rating_to_cpus.sql'
